...
namespace UDateTime {
	...
	// Precondicion: Ninguna
	// Postcondicion: Devuelve una instancia valida de DateTime para la fecha y hora especificada. Si @month, @day, @hour, @minute y @seconds, no se corresponden a una fecha y hora posible
	...
	// Postcondicion: Devuelve el ano de @dateTime.
